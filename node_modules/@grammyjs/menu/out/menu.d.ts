import { type Context, type Filter, type InlineKeyboardButton, type InlineKeyboardMarkup, type LoginUrl, type Middleware, type MiddlewareObj, type SwitchInlineQueryChosenChat } from "./deps.node.js";
/**
 ...
 */
type MenuMiddleware<C extends Context> = Middleware<Filter<C, "callback_query:data"> & MenuFlavor>;
...
type MaybePayloadString<C extends Context> = MaybeDynamicString<C> | TextAndPayload<C>;
